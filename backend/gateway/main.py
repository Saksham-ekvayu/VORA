...
app = FastAPI(title=f"{SERVICE_NAME}", description="API Gateway for development to proxy requests to backend services")
...
async def gateway(path: str, request: Request):
    if path == "" or path == "/":
        return {"success": True, "message": "Welcome to the Local API Gateway. Use /api/... to reach backend services."}
