...
if errorlevel 1 (
    ...
    start "ai-analysis-service" cmd /k "cd /d "%ROOT%\services\ai-analysis-service" && .venv\Scripts\activate.bat && python -m uvicorn app.main:app --host localhost --port 7008 --reload --reload-dir . --reload-dir ..\..\shared"
...
wt -w new new-tab --title "authentication-service" -d "%ROOT%\services\authentication-service" cmd /k ".venv\Scripts\activate.bat && python -m uvicorn app.main:app --host localhost --port 7001 --reload --reload-dir . --reload-dir ..\..\shared" ^
    ...
    ; new-tab --title "ai-analysis-service" -d "%ROOT%\services\ai-analysis-service" cmd /k ".venv\Scripts\activate.bat && python -m uvicorn app.main:app --host localhost --port 7008 --reload --reload-dir . --reload-dir ..\..\shared" ^
