...
if errorlevel 1 (
    ...
    start "deployment-document-service" cmd /k "cd /d "%ROOT%\services\deployment-document-service" && .venv\Scripts\activate.bat && python -m uvicorn app.main:app --host localhost --port 7007 --reload --reload-dir . --reload-dir ..\..\shared"
...
wt -w new new-tab --title "authentication-service" -d "%ROOT%\services\authentication-service" cmd /k ".venv\Scripts\activate.bat && python -m uvicorn app.main:app --host localhost --port 7001 --reload --reload-dir . --reload-dir ..\..\shared" ^
    ...
    ; new-tab --title "deployment-document-service" -d "%ROOT%\services\deployment-document-service" cmd /k ".venv\Scripts\activate.bat && python -m uvicorn app.main:app --host localhost --port 7007 --reload --reload-dir . --reload-dir ..\..\shared" ^
