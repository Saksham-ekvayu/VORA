...
def get_shared_styles() -> dict[str, ParagraphStyle]:
    ...
    return {
        ...
        "cover_title1": ParagraphStyle(
            "Title1", fontName="Helvetica-Bold", fontSize=32, textColor=COLORS["dark_text"], leading=36, rightIndent=60*mm
        ),
        "cover_title2": ParagraphStyle(
            "Title2", fontName="Helvetica-Bold", fontSize=32, textColor=COLORS["primary"], leading=36, spaceAfter=20
        ),
        "cover_subtitle1": ParagraphStyle(
            "SubTitle1", fontName="Helvetica-Bold", fontSize=22, textColor=COLORS["dark_text"], leading=26, rightIndent=60*mm
        ),
        "cover_subtitle2": ParagraphStyle(
            "SubTitle2", fontName="Helvetica", fontSize=12, textColor=COLORS["muted_text"], spaceBefore=10, spaceAfter=30, rightIndent=60*mm
        ),
        "toc_invisible_section": ParagraphStyle(
            name='TOCEntrySection', fontSize=0, leading=0, spaceBefore=0, spaceAfter=0, textColor=colors.transparent
        ),
        "toc_invisible_control": ParagraphStyle(
            name='TOCEntryControl', fontSize=0, leading=0, spaceBefore=0, spaceAfter=0, textColor=colors.transparent
        ),
